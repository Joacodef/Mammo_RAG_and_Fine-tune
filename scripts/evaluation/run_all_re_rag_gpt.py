...
def main():
    # 1. Clean RE RAG
    print("=================== 1. Running Clean RE RAG (GPT-4o) ===================")
    run_cmd([
        sys.executable, "scripts/evaluation/generate_rag_predictions.py",
        "--config-path", "configs/rag_re_gpt_config.yaml",
    ...
    print("\nEvaluating Clean RE RAG (GPT-4o)...")
    run_cmd([
    ...
    print("\n=================== 2. Running Light Noisy RE RAG (GPT-4o) ===================")
    run_cmd([
        sys.executable, "scripts/evaluation/generate_rag_predictions.py",
        "--config-path", "configs/rag_re_gpt_config.yaml",
    ...
    print("\nEvaluating Light Noisy RE RAG (GPT-4o)...")
    run_cmd([
        sys.executable, "scripts/evaluation/calculate_final_metrics.py",
    ...
    print("\n=================== 3. Running Heavy Noisy RE RAG (GPT-4o) ===================")
    run_cmd([
        sys.executable, "scripts/evaluation/generate_rag_predictions.py",
        "--config-path", "configs/rag_re_gpt_config.yaml",
    ...
    print("\nEvaluating Heavy Noisy RE RAG (GPT-4o)...")
    run_cmd([
        sys.executable, "scripts/evaluation/calculate_final_metrics.py",
    ...
    print("\n=================== All RE RAG (GPT-4o) prediction and evaluation runs completed successfully! ===================")
